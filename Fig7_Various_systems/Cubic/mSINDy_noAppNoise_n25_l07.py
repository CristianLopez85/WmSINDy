...
from utils_NSS_SINDy_cubic import *
import time
...
Xi_base[5,0]=-0.1;Xi_base[5,1]=-2;
Xi_base[8,0]=2;Xi_base[8,1]=-0.1;
...
savemat("m_noAppNoise_cubic_n10.mat", data_dict)