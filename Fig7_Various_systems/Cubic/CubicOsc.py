# -*- coding: utf-8 -*-
"""
Created on Fri Jan 17 14:18:57 2025
...
from utils_NSS_SINDy_W_cubic import *
import time
...
from utils_WSINDy_cubic import *
...
x = odeint(CubicOsc,x0,tobs,args=(p0,),rtol = 1e-12, atol = 1e-12)
dx = np.transpose(CubicOsc(np.transpose(x), 0, p0))             # derivative of the trajectory
...
plt.savefig('Fig7e_CubicOsc_noisy.pdf')
rr
...
plt.grid(False)
plt.axis('off')
plt.savefig('Fig7e_CubicOsc_denoised.pdf')
