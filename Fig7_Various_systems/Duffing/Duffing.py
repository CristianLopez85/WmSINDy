# -*- coding: utf-8 -*-
"""
Created on Fri Jan 17 12:45:28 2025
...
In the file 'utils_WSINDy':
   3.- In def get_tags_SINDy(n): if n ==3:   # For VanderPol, and Cubic, Duffing
"""
...
x = odeint(Duffing,x0,tobs,args=(p0,),rtol = 1e-12, atol = 1e-12)
dx = np.transpose(Duffing(np.transpose(x), 0, p0))             # derivative of the trajectory
...
plt.savefig('Fig7d_Duffing_noisy.pdf')
...
plt.grid(False)
plt.axis('off')
plt.savefig('Fig7d_Duffing_denoised.pdf')
