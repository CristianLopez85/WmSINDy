...
import scipy.io
Res_mSINDy = scipy.io.loadmat('m_NoAppNoise_LV_n30.mat')  # Load the MATLAB .mat file into Python
Res_WmSINDy = scipy.io.loadmat('Wm_appNoise20_LV_n30.mat')  # Load the MATLAB .mat file into Python
