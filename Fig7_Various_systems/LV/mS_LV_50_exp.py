...
from utils_NSS_SINDy_LV import *
import time
...
Xi_base[0,0]=1
Xi_base[1,1]=-2
Xi_base[3,0]=-0.5;Xi_base[3,1]=0.5
...
for i in range(N_run):
    ...
    for j in range(Lambda_List_Num):
        ...
        for k in range(Nloop):
            ...
            # overfit_cost = np.count_nonzero(W) / W.shape[0]
...
savemat("m_AppNoise_LV_n30.mat", data_dict)