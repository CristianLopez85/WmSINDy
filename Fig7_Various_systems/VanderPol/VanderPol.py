# -*- coding: utf-8 -*-
"""
Created on Fri Jan 17 12:15:10 2025
...
from utils_NSS_SINDy_W_VanderPol import *
import time
...
from utils_WSINDy_VanderPol import *

""" 
If using grid points, please change the following:
In the file 'utils_NSS_SINDy_W':
   1.- Check that LibGPU(x) is for VdP/Duffing Oscillator/ Cubic Osc
...
x = odeint(VanderPol,x0,tobs,args=(p0,),rtol = 1e-12, atol = 1e-12)
...
plt.savefig('Fig7c_VanderPol_noisy.pdf')
...
plt.grid(False)
plt.axis('off')
plt.savefig('Fig7c_VanderPol_denoised.pdf')
