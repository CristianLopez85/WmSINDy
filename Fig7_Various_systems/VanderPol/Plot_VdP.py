...
import scipy.io
Res_mSINDy = scipy.io.loadmat('m_AppNoise20_VdP_n25.mat')  # m_AppNoise20_VdP
Res_WmSINDy = scipy.io.loadmat('Wm_appNoise20_VdP.mat')  # Load the MATLAB .mat file into Python
