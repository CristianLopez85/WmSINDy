...
import scipy.io
Res_mSINDy = scipy.io.loadmat('m_noAppNoise_Lorenz_q1_n40.mat')  # Load the MATLAB .mat file into Python
Res_WmSINDy = scipy.io.loadmat('Wm_noAppNoise_Lorenz_q1_n40.mat')  # Load the MATLAB .mat file into Python
