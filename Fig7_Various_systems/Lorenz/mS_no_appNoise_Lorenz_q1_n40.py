...
from utils_NSS_SINDy_Lorenz import *
import time
...
for i in range(N_run):
    ...
    for j in range(Lambda_List_Num):
        ...
        #-------------------- NO Smoothing  ----------------------------- by CL, uncomment 166, and use xn instead of xes in lines 169 and 172
...
savemat("m_noAppNoise_Lorenz_q1_n40.mat", data_dict)