...
loc = np.array([[0.0,  0.0, 0.0], 
                [0.00018181,  0.00033583, -0.00097135],
                [-0.00354508, -0.0028554 ,  0.00342108],
                [ 0.0019991 ,  0.00596214, -0.00591292],
                [ 0.00384222, -0.00400695,  0.00533638],
                [-0.00053639, -0.00189822, -0.00674135],
                [-0.00185702, -0.00024482, -0.0088012 ],
                [ 0.00747661,  0.00926299, -0.00444949],
                [-0.00220506, -0.00193656, -0.00707796],
                [-0.0222886 , -0.01340408,  0.00538109],
                [-0.02025233, -0.00326221, -0.01173433]])
# c = scale * np.sqrt(3)
c = np.array([[0.0,  0.0, 0.0], 
              [0.67512039, 0.76310048, 0.72971378],
              [1.3519529  ,1.51909504, 1.45974743],
              [2.02718982 ,2.28594018, 2.19218339],
              [2.70596399 ,3.04997857, 2.91195352],
              [3.39097836 ,3.81959848, 3.64410875],
              [4.04183811 ,4.55957801, 4.36809091],
              [4.71589327 ,5.34529533, 5.09631439],
              [5.40063097 ,6.10814875, 5.83461285],
              [6.06037752 ,6.87491435, 6.55573469],
              [6.7461121  ,7.64616563, 7.2730849 ]])

# Or just loc = 0 and c = (np.array(NoiseMag))*np.sqrt(3.0)     as in WSINDy
#%%
# =============================================================================
...
for i in range(N_run):
    ...
    for j in range(NoiseNum):
        ...
        # Generate the noise
        Noise = np.hstack([loc[j,i] + np.random.uniform(-c[j,i],c[j,i],(dataLen,1)) for i in range(stateVar)])              # Uniform Noise
...
savemat("WmLorenz_Uniform.mat", data_dict)