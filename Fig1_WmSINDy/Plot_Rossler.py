...
for k in range(Nloop):
    ...
    NoiseID,totalTime = Train_NSS_SINDy(Y,Y0,Ypre_F,Ypre_B,NoiseVar,Xi,Xi_act,weights,dt,q,stateVar,dataLen,optimizer,N_train,V,Vp, Grid) 
        
    v_up, vp_up, grid_up,kup = v_vp_grid(xn[q+1:-q-1,:] ,NoiseID[q+1:-q-1,:], tags, stateVar,custom_fcns, tobs, tau, tauhat, max_d, phi_class, K_frac)
...
Xi_base[0,2]=0.2
Xi_base[1,1]=1
Xi_base[2,0]=-1; Xi_base[2,1]=0.2;
Xi_base[3,0]=-1; Xi_base[3,2]=-5.7;
Xi_base[6,2]=1
