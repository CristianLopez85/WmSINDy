...
Res_mSINDy = scipy.io.loadmat('mSINDYc_Res.mat')  # Load the MATLAB .mat file into Python

Res_WmSINDy = scipy.io.loadmat('WmSINDy_Res.mat')  # Load the MATLAB .mat file into Python

Res_WSINDy = scipy.io.loadmat('WSINDy_Res.mat')  # Load the MATLAB .mat file into Python
Nloop = 5
