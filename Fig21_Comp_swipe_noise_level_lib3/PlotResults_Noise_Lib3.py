...
Res_mSINDy = scipy.io.loadmat('mLorenz_lib3.mat')  # Load the MATLAB .mat file into Python

Res_WmSINDy = scipy.io.loadmat('WmLorenz_lib3.mat')  # Load the MATLAB .mat file into Python

Res_WSINDy = scipy.io.loadmat('WLorenz_noise_Exp50_fullqp_lib3.mat')  # Load the MATLAB .mat file into Python
Nloop = 5
...
plt.ylim([1e-7, 0.5])   # plt.ylim([1e-4, 1e0])
ax1.yaxis.grid(True)
plt.savefig("p2c.pdf")
