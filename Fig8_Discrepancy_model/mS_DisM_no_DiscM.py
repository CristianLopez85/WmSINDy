...
for i in range(N_run):
    ...
    for j in range(NoiseNum):
        ...
        # Define the estimated parameters                                      # ! Commented and lines 232-234 
        ...
        for k in range(Nloop):
            ...
            # index_min[0,0]=True;index_min[1,0]=True;                         # ! Commented and lines 188-190
...
savemat("mS_no_DisM.mat", data_dict)